...
public class Color implements Serializable {
	...
	/**
	 * Lerp a color using linear interpolation.
	 * 
	 * @param start The initial colour
	 * @param end The final colour
	 * @param t The amount at which to interpolate (0 -> 1)
	 * @return The color generated from the interpolation
	 */
	public static Color lerp(Color start, Color end, float t) {
		Color col = new Color(1f, 1f, 1f, 1f);
		
		col.r = start.r + t*(end.r - start.r);
		col.g = start.g + t*(end.g - start.g);
		col.b = start.b + t*(end.b - start.b);
		col.a = start.a + t*(end.a - start.a);
