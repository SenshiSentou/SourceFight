...
public class Animation implements Renderable {
	...
	/**
	 * Set an animation frame to an image
	 * @param index The index of the frame to replace
	 * @param frame The image to display for the frame
	 * @param duration The duration of this frame in milliseconds
	 */
	public void setFrame(int index, Image frame, int duration) {
		frames.set(index, new Frame(frame, duration));
	}
	...
	/**
	 * Get the duration of the entire animation
	 * 
