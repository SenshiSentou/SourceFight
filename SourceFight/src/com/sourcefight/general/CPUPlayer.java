...
//	private MoveDirection moveDirection = MoveDirection.None;
	...
	public CPUPlayer(Game game, Stage stage, String spriteSheetPath, float x, float size, Character other, boolean copyAnims, int difficulty) throws SlickException {
